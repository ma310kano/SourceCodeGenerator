...
public record class NumberGenerationCommand(string NamespaceSequence, string ClassName, string ClassDescription, bool HasPlusOperator, bool HasMinusOperator, bool HasMinimumNumber, int MinimumNumber, bool HasMaximumNumber, int MaximumNumber);