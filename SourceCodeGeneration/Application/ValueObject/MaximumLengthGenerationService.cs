...
/// 値オブジェクト(最大長)の生成サービス
/// </summary>
public class MaximumLengthGenerationService : IMaximumLengthGenerationService
{
	#region Methods
	...
	public Stream Generate(MaximumLengthGenerationCommand command)
	{
	...
	/// <param name="command">コマンド</param>
	/// <returns>生成したストリームを返します。</returns>
	public async Task<Stream> GenerateAsync(MaximumLengthGenerationCommand command)
	{
