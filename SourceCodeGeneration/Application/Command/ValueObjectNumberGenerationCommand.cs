...
public record class ValueObjectNumberGenerationCommand(string NamespaceSequence, string ClassName, string ClassDescription, bool HasMinimumNumber, int MinimumNumber, bool HasMaximumNumber, int MaximumNumber);